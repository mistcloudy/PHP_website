...
$pdo = db_connect();
 ...
 $sql="select * from test.greet where $find like '%$search%' order by num desc";
 } else {
 $sql="select * from test.greet order by num desc";
 }
    try{
 $stmh = $pdo->query($sql);
$count=$stmh->rowCount();
...
<div id="content">
 ...
 <?php include "../lib/left_menu.php"; ?>
        ...
        <div id="col2">
 <div id="title"><img src="../img/title_memo2.gif"></div> <form name="board_form" method="post" action="list.php?mode=search">
<div id="list_search">
